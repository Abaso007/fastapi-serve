...
if sys.version_info < (3, 7, 0):
    raise OSError(f"fastapi-serve requires Python >=3.7, but yours is {sys.version}")

try:
    pkg_name = "fastapi-serve"
    libinfo_py = path.join("fastapi_serve", "__init__.py")
...
setup(
    ...
    download_url="https://github.com/jina-ai/fastapi-serve/tags",
    ...
    entry_points={
        "console_scripts": [
            "fastapi-serve=fastapi_serve.__main__:serve",
        ],
    },
    extras_require={
        "test": [
